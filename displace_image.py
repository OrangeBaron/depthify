...
def create_displaced_image(color_image_path, depthmap_path, output_path, levels, eye):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--eye", choices=["left", "right"], default="right", help="Punto di vista dell'occhio (default: right).")

    # Leggi gli argomenti
    args = parser.parse_args()

    # Esegui la funzione
    create_displaced_image(args.color_image, args.depthmap, args.output_image, args.levels, args.eye)
